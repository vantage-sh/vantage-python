...
class CostsAsyncApi:
    ...
    async def create_export(self, body: CreateCostExport) -> str:
        """
...
class FoldersAsyncApi:
    ...
    async def list(self, *, page: Optional[int] = None, limit: Optional[int] = None, type: Optional[str] = None) -> Folders:
        """
        Get all folders
...
class ManagedAccountsAsyncApi:
    ...
    async def delete_sso_connection_for(self, managed_account_token: str) -> None:
        """
...
class RecommendationsAsyncApi:
    ...
    async def get_resource(self, recommendation_token: str, resource_token: str) -> RecommendationProviderResource:
        """
